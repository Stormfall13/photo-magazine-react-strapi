(self.webpackChunkapi=self.webpackChunkapi||[]).push([[2544],{23341:(Y,Z,r)=>{"use strict";r.r(Z),r.d(Z,{CreatePage:()=>Ce,default:()=>Me});var e=r(67294),E=r(66115),o=r(73599),T=r(185),I=r(53979),b=r(11047),P=r(29728),R=r(49066),x=r(41580),B=r(75515),j=r(11276),F=r(74571),y=r(16364),u=r(64256),N=r(67109),Q=r(41054),z=r(27361),he=r.n(z),A=r(41609),X=r.n(A),me=r(86896),h=r(16550),q=r(1565),w=r(18280),ee=r(48474),ie=r(87751),le=r(87561);const ye=le.Ry().shape({name:le.Z_().required(o.I0.required),description:le.Z_().required(o.I0.required)}),ce=q.ZP.div`
